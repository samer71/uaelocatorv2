...
function renderStore(prox,label,name,stlat,stlon,da,ef,h,c,desc,fac) {
	...
	if(parseFloat(distance,2)<=parseFloat(prox/1000,2)) {
		...
		$("#list").append('<li class="onestore"><a class="dlink" id="'+label+'" href="#details" data-role="button" data-transition="slide">'+name+' ('+distance+'KM)</a><span class="ui-li-count ui-btn-corner-all">'+label+'</span></li>');
		/*
